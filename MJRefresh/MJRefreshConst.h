...
//RGB 颜色
#define MJRefreshREBColor(r, g, b) [UIColor colorWithRed:(r/255.0) green:(g/255.0) blue:(b/255.0) alpha:1.0]
// 文字颜色
#define MJRefreshLabelTextColor MJRefreshREBColor(90, 90, 90)
// 字体大小
